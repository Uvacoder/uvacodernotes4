...
| [FDR Free Font Section](https://freedesignresources.net/category/free-fonts/) | Handpicked free fonts to create a beautiful design. Ranging from script, display, sans serif, serif, display, and more. |
...
| [Khroma](http://khroma.co/)                                        | uses AI to learn which colors you like and creates limitless palettes for you to discover, search, and save.    |
